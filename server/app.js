...
app.post('/puppies', async (req, res, next) => {
    ...
    const params = [
        ...
        req.body.breed,
        req.body.weight_lbs,
        req.body.microchipped
    ];

    const newPuppy = await Puppy.create({ name: params[0], age_yrs: params[1], breed: params[2], weight_lbs: params[3], microchipped: params[4] });

    res.json({
        data: newPuppy,
        message: 'Dog successfully saved'
    })
})
